...
return [
    ...
    */
    ...
    | by Laravel's translation / localization services. This value can be
    | safely modified to any of the locales which will be supported by the
    | application.
    |
    */
