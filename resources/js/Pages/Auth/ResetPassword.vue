    ...
    <div class="main-login-bg">
        <div class="login-container">
            ...
            <div class="login-right-pane position-relative">
                ...
                <!-- Title -->
                <div class="login-title">{{ $t('messages.reset_password') }}</div>
                <div class="login-sub">
            ...
            this.form.post(route('password.store'), {
                ...
                onError: (errors) => {
                    ...
                    if (this.isRateLimitError(errors)) {
                        console.log('addressing rate limit error...');
                        ...
                        const translatedMessage =
                            emailError?.key
                                ? this.t('messages.rate_limit.password_reset', { minutes })
                                : emailError;

                        console.log('Rate limit error detected:', translatedMessage);

                        Swal.fire({
                            icon: 'warning',
                            title: this.$t('messages.rate_limit.password_reset'),
