                    ...
                    <tr v-for="item in cartItems" :key="item.id">
                        <th scope="row">
                            <div class="d-flex align-items-center">
                                <img :src="item.Products?.media?.[0]?.url || 'img/vegetable-item-3.png'" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                            </div>
                        </th>
                        <td>
                        ...
                        <td>
                            <p class="mb-0 mt-4">{{ (item.total).toLocaleString('vi-VN', {style: 'currency', currency: 'VND'}) }}</p>
                        </td>
                        <td>
                    ...
                    <div class="bg-light rounded">
                        <div class="p-4">
                            ...
                            <div class="d-flex justify-content-between mb-4">
                                ...
                                <p class="mb-0">{{ cartTotal.toLocaleString('vi-VN', {style: 'currency', currency: 'VND'}) }}</p>
                            </div>
