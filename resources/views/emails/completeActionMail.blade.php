...
<head>
    ...
    <title>
        @if($type === 'password_reset')
            {{ __('messages.email.complete_action.password_reset.title') }}
        @else
            {{ __('messages.email.complete_action.register.title') }}
        @endif
    </title>
                ...
                <tr>
                    <td align="center" class="container-padding">
                        <table class="row" width="580" style="width:80%;">
                            ...
                            {{-- Title --}}
                            <tr>
                                <td style="font-size:20px;font-weight:600;color:#222;">
                                    @if($type === 'password_reset')
                                        {{ __('messages.email.complete_action.password_reset.title') }}
                                    @else
                                        {{ __('messages.email.complete_action.register.title') }}
                            ...
                            <tr>
                                <td style="font-size:14px;line-height:22px;color:#444;">
                                    @if($type === 'password_reset')
                                        {{ __('messages.email.complete_action.password_reset.message') }}
                                    @else
                                        {{ __('messages.email.complete_action.register.message') }}
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="font-size:14px;line-height:22px;color:#444;">
                                    @if($type === 'password_reset')
                                        {{ __('messages.email.complete_action.password_reset.instruction') }}
                                    @else
                                        {{ __('messages.email.complete_action.register.instruction') }}
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center">
                                    <a href="{{ $url }}" style="display:inline-block;padding:14px 32px;background:#81c408;color:#ffffff;border-radius:5px;font-weight:500;font-size:14px;">
                                        @if($type === 'password_reset')
                                            {{ __('messages.email.complete_action.password_reset.button') }}
                                        @else
                                            {{ __('messages.email.complete_action.register.button') }}
                                        @endif
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center">
                                    <a href="https://fruitable.site/about" style="display:inline-block;padding:10px 22px;background:#f5f5f5;color:#81c408;border:1px solid #81c408;border-radius:4px;font-size:14px;font-weight:500;">
                                        {{ __('messages.email.complete_action.project_info_button') }}
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="font-size:13px;line-height:20px;color:#777;">
                                    {{ __('messages.email.complete_action.footer_text') }}
                                </td>
                            </tr>
